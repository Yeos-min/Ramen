      ...
      <div className="flex-1 relative min-h-0">
        ...
        <div className="absolute bottom-0 left-0 right-0 z-20">
          {mapReady && searching && !selectedPlace && (
            <SearchingSkeletonCard accent={accent} subColor={subColor} mutedColor={mutedColor} chipBg={chipBg} />
          )}
    ...
    <div style={{ background: 'linear-gradient(to top, rgba(255,251,245,1) 85%, transparent)', paddingTop: '24px' }}>
      ...
      <div className="px-[18px] pb-[28px] flex flex-col gap-[14px]">
        <div className="flex items-center gap-[10px]">
          ...
          <span className="text-[13px]" style={{ fontFamily: "'WenQuanYi Zen Hei',sans-serif", color: accent, fontWeight: 600 }}>
            울산 라멘집 탐색 중...
          </span>
        </div>
        <div className="flex flex-col gap-[10px]">
          <div className="animate-pulse h-[22px] rounded-[8px] w-[55%]" style={{ backgroundColor: shimmer }} />
          <div className="animate-pulse h-[13px] rounded-[6px] w-[82%]" style={{ backgroundColor: shimmer }} />
          <div className="animate-pulse h-[13px] rounded-[6px] w-[45%]" style={{ backgroundColor: shimmer }} />
        </div>
        <div className="flex gap-[8px]">
          <div className="animate-pulse flex-1 h-[46px] rounded-[12px]" style={{ backgroundColor: shimmer }} />
          <div className="animate-pulse flex-[2] h-[46px] rounded-[12px]" style={{ backgroundColor: shimmer }} />
        </div>
      </div>
    </div>
  );
      ...
      <div className="px-[18px] pb-[28px] flex flex-col gap-[14px]">
        <div className="flex items-start gap-[10px]">
          <div className="flex flex-col gap-[4px] flex-1 min-w-0">
            <span className="text-[20px] tracking-[-0.5px] leading-tight" style={{ fontFamily: "'WenQuanYi Zen Hei',sans-serif", fontWeight: 700, color: titleColor }}>
              {place.place_name}
            </span>
            <span className="text-[12px] leading-relaxed" style={{ fontFamily: "'WenQuanYi Zen Hei',sans-serif", color: subColor }}>
              {addr}
            </span>
            {place.phone && (
              <span className="text-[12px]" style={{ fontFamily: "'Manrope',sans-serif", color: mutedColor }}>
                📞 {place.phone}
              </span>
            )}
          </div>
          <button onClick={onClose} className="size-[32px] flex items-center justify-center rounded-full shrink-0 mt-[2px] active:scale-[0.92] transition-transform" style={{ backgroundColor: chipBg }}>
        ...
        <div className="flex gap-[8px]">
          <button onClick={() => window.open(place.place_url, '_blank', 'noopener,noreferrer')} className="flex-1 rounded-[12px] py-[13px] flex items-center justify-center gap-[6px] active:scale-[0.97] transition-transform" style={{ backgroundColor: chipBg, border: `1px solid ${border}` }}>
            ...
            <span className="text-[13px]" style={{ fontFamily: "'WenQuanYi Zen Hei',sans-serif", color: accentSoft }}>지도 앱</span>
          </button>
          <button onClick={() => onDirections(place)} className="flex-[2] rounded-[12px] py-[13px] flex items-center justify-center gap-[6px] active:scale-[0.97] transition-transform" style={{ background: `linear-gradient(135deg, ${accentSoft}, ${accent})`, boxShadow: `0 8px 24px ${accentGlowStrong}` }}>
            <svg className="size-[16px]" fill="none" viewBox="0 0 20 20">
              <path d="M10 2L14 8H11V14H9V8H6L10 2ZM3 14H17V16H3V14Z" fill={labelColor} />
            </svg>
            <span className="text-[14px]" style={{ fontFamily: "'WenQuanYi Zen Hei',sans-serif", fontWeight: 700, color: labelColor }}>길찾기</span>
          </button>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="flex gap-[5px] items-center">
      {[0, 150, 300].map((delay, i) => (
        <div key={i} className="size-[5px] rounded-full animate-bounce" style={{ backgroundColor: accent, animationDelay: `${delay}ms`, animationDuration: '900ms' }} />
      ))}
    </div>
  );
}
